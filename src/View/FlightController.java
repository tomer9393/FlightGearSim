...
public class FlightController implements Initializable, Observer {
    ...
    public void setViewModel(ViewModel viewModel){
        ...
        plane=new Image[8];
        plane[0]=new Image(getClass().getClassLoader().getResourceAsStream("View/pics/plane0.png"));
        plane[0]=new Image(getClass().getClassLoader().getResourceAsStream("View/pics/plane0.png"));
        plane[1]=new Image(getClass().getClassLoader().getResourceAsStream("View/pics/plane45.png"));
        plane[2]=new Image(getClass().getClassLoader().getResourceAsStream("View/pics/plane90.png"));
        plane[3]=new Image(getClass().getClassLoader().getResourceAsStream("View/pics/plane135.png"));
        plane[4]=new Image(getClass().getClassLoader().getResourceAsStream("View/pics/plane180.png"));
        plane[5]=new Image(getClass().getClassLoader().getResourceAsStream("View/pics/plane225.png"));
        plane[6]=new Image(getClass().getClassLoader().getResourceAsStream("View/pics/plane270.png"));
        plane[7]=new Image(getClass().getClassLoader().getResourceAsStream("View/pics/plane315.png"));
        mark=new Image(getClass().getClassLoader().getResourceAsStream("View/pics/mark.png"));
    ...
    public void LoadMap() {
		...
		ExtensionFilter fileExtensions = new ExtensionFilter("CSV files (*.csv)", "*.csv");
    ...
    public void Connect(){
		...
		window.setTitle("Connect to FlightGear");
    ...
    public void AutoPilot(){
    	if(manual.isSelected())
        {
			...
			fc.setInitialDirectory(new File("./Resources"));
			ExtensionFilter fileExtensions = new ExtensionFilter("TEXT files (*.txt)", "*.txt");
			fc.getExtensionFilters().add(fileExtensions);
			File selectedFile = fc.showOpenDialog(null);
			try {
				if (selectedFile != null) {
